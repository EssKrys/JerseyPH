...
function elessi_enqueue_style() {
    ...
    if (NASA_WOO_ACTIVED) {
        ...
        if (isset($nasa_opt['css_canvas']) && $nasa_opt['css_canvas'] == 'sync') {
            ...
            if (!isset($nasa_opt['loop_layout_buttons']) || $nasa_opt['loop_layout_buttons'] != 'modern-7') {
...
function elessi_get_list_css_files_call() {
    ...
    if (NASA_WOO_ACTIVED) {
        ...
        /* $list_css['wc-blocks-style-active-filters'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/active-filters.css';
        $list_css['wc-blocks-style-add-to-cart-form'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/add-to-cart-form.css';
        $list_css['wc-blocks-packages-style'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/packages-style.css';
        $list_css['wc-blocks-style-all-products'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/all-products.css';
        $list_css['wc-blocks-style-all-reviews'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/all-reviews.css';
        $list_css['wc-blocks-style-attribute-filter'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/attribute-filter.css';
        $list_css['wc-blocks-style-breadcrumbs'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/breadcrumbs.css';
        $list_css['wc-blocks-style-catalog-sorting'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/catalog-sorting.css';
        $list_css['wc-blocks-style-customer-account'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/customer-account.css';
        $list_css['wc-blocks-style-featured-category'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/featured-category.css';
        $list_css['wc-blocks-style-featured-product'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/featured-product.css';
        $list_css['wc-blocks-style-mini-cart'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/mini-cart.css';
        $list_css['wc-blocks-style-price-filter'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/price-filter.css';
        $list_css['wc-blocks-style-product-add-to-cart'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-add-to-cart.css';
        $list_css['wc-blocks-style-product-button'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-button.css';
        $list_css['wc-blocks-style-product-categories'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-categories.css';
        $list_css['wc-blocks-style-product-image'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-image.css';
        $list_css['wc-blocks-style-product-image-gallery'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-image-gallery.css';
        $list_css['wc-blocks-style-product-query'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-query.css';
        $list_css['wc-blocks-style-product-results-count'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-results-count.css';
        $list_css['wc-blocks-style-product-reviews'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-reviews.css';
        $list_css['wc-blocks-style-product-sale-badge'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-sale-badge.css';
        $list_css['wc-blocks-style-product-search'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-search.css';
        $list_css['wc-blocks-style-product-sku'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-sku.css';
        $list_css['wc-blocks-style-product-stock-indicator'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-stock-indicator.css';
        $list_css['wc-blocks-style-product-summary'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-summary.css';
        $list_css['wc-blocks-style-product-title'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-title.css';
        $list_css['wc-blocks-style-rating-filter'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/rating-filter.css';
        $list_css['wc-blocks-style-reviews-by-category'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/reviews-by-category.css';
        $list_css['wc-blocks-style-reviews-by-product'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/reviews-by-product.css';
        $list_css['wc-blocks-style-product-details'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/product-details.css';
        $list_css['wc-blocks-style-single-product'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/single-product.css';
        $list_css['wc-blocks-style-stock-filter'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/stock-filter.css';
        $list_css['wc-blocks-style-cart'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/cart.css';
        $list_css['wc-blocks-style-checkout'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/checkout.css';
        $list_css['wc-blocks-style-mini-cart-contents'] = '/plugins/woocommerce/packages/woocommerce-blocks/build/mini-cart-contents.css';
         * */
    }
    ...
    if (NASA_ELEMENTOR_ACTIVE) {
        ...
        // $list_css['elementor-frontend'] = '/plugins/elementor/assets/css/frontend-lite.min.css';
