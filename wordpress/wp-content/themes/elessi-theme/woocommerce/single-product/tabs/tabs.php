        ...
        if (!isset($nasa_opt['ns_rm_sl']) || $nasa_opt['ns_rm_sl']) {
            echo '
                ...
                <div class="ns-read-more">
                    <a href="javascript:void(0);" data-show-less="' . esc_attr__("Show less", "elessi-theme") . '" data-show-more="' . esc_attr__("Read more", "elessi-theme") . '" class="ns-btn-read-more primary-color">
