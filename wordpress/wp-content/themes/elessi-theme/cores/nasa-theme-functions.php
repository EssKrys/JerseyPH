...
if (!function_exists('elessi_prev_next_post')) :
    function elessi_prev_next_post() {
        ...
        $html .= '<span class="nasa-icon nasa-iflex"><svg viewBox="0 0 512 512" width="30" height="30" fill="currentColor"><path d="M0 444l0-34 512 0 0 34z m0-205l512 0 0 34-512 0z m0-171l512 0 0 34-512 0z"></path></svg></span>';
        $html .= '</a>';
        $html .= '</div>';
