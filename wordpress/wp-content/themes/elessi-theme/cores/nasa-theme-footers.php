...
if (!function_exists('elessi_static_cart_popup')) :
    function elessi_static_cart_popup() {
        ...
        if (isset($nasa_opt['event-after-add-to-cart']) && $nasa_opt['event-after-add-to-cart'] == 'popup_2') {
            ...
            echo '<div class="ns-cart-popup-wrap"><a class="popup-cart-bg-close" href="javascript:void(0);" title="Close (Esc)"></a><div class="ns-cart-popup-container ns-popup-container_v2"><div id="ns-cart-popup" class="nasa-after-add-to-cart-wrap ns-cart-popup ns-cart-popup-v2">'.
...
if (!function_exists('elessi_fake_purchased_tmpl')) :
    function elessi_fake_purchased_tmpl() {
        ...
        <script type="text/template" id="ns-sale-notification-tml">
            ...
            <a class="ns-noti-link quick-view nasa-flex jc" href="javascript:void(0);" data-prod="{{p_data_prod}}" title="<?php  esc_attr_e('Quick View', 'elessi-theme'); ?> {{p_name}}" target="_blank"><svg version="1.1" width="20" height="20" viewBox="0 0 32 32">
