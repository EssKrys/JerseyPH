...
if (!function_exists('elessi_footer_heading')) {
    function elessi_footer_heading() {
        ...
        $of_options[] = array(
            ...
            'class' => 'nasa-footer_mode nasa-footer_mode-builder nasa-theme-option-child ns-wpb-type',
        ...
        $of_options[] = array(
            ...
            'std' => 'default',
            'select_class' => 'nasa-ad-select2',
            'class' => 'nasa-footer_mode nasa-footer_mode-builder-e nasa-theme-option-child ns-hfe-type',
