        ...
        $(_sliders).each(function() {
            ...
            if (!$(_this).hasClass('slick-initialized')){
                ...
                var _setting = {
                    ...
                    touchThreshold: 10,
                    cssEase: 'ease-out',
                    prevArrow: '<a class="nasa-nav-arrow slick-prev" href="javascript:void(0);" rel="nofollow"></a>',
                    nextArrow: '<a class="nasa-nav-arrow slick-next" href="javascript:void(0);" rel="nofollow"></a>'
                };
