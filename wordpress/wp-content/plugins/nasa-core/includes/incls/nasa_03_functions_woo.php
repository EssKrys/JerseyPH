...
function nasa_static_viewed_sidebar() {
    ...
    <div id="nasa-viewed-sidebar" class="<?php echo esc_attr($nasa_viewed_style); ?>">
        <div class="viewed-close nasa-sidebar-close">
            <a href="javascript:void(0);" title="<?php esc_attr_e('Close', 'nasa-core'); ?>" rel="nofollow"><?php esc_html_e('Close', 'nasa-core'); ?>
...
function nasa_fake_view() {
    ...
    $fake_view .= '<svg width="20" height="22" viewBox="0 0 26 32" fill="currentColor">
