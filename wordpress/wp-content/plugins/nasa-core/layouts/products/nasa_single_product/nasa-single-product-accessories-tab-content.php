...
<div class="row nasa-relative nasa-bought-together-wrap">
    ...
    <div class="large-9 columns rtl-right">
        <div class="nasa-accessories-wrap row nasa-flex flex-wrap">
            <!-- Current product -->
            <div class="nasa-large-5-col-1 small-6 medium-4 columns nasa-current-product wow fadeInUp product-item grid rtl-right" data-wow-duration="1s" data-wow-delay="<?php echo esc_attr($_delay); ?>ms" data-wow="fadeInUp">
                <!-- Thumbnail -->
            ...
            foreach ($accessories as $acc) :
                ...
                <div class="nasa-large-5-col-1 small-6 medium-4 columns nasa-accessories-product wow fadeInUp product-item grid nasa-accessories-<?php echo (int) $product_id; ?> rtl-right" data-wow-duration="1s" data-wow-delay="<?php echo esc_attr($_delay); ?>ms" data-wow="fadeInUp">
                    <!-- Thumbnail -->
                    <div class="product-img">
    ...
    <div class="large-3 columns mobile-margin-bottom-20 rtl-left text-right rtl-text-left mobile-text-left rtl-mobile-text-right nasa-accessories-total-price-wrap">
        <div class="nasa-accessories-total-price">
            <?php echo esc_html__('Total Price: ', 'nasa-core') . '<span class="price">' . wc_price($total_price) . $suffix . '</span>'; ?>
        </div>
