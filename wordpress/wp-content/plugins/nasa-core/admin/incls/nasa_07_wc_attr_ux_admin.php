            ...
            case self::_NASA_COLOR :
                ...
                <div class="colors-wrap nasa-flex flex-column align-start">
                    <div class="main-color-wrap ns-color-item">
                        ...
                        <input type="text" id="term-<?php echo esc_attr($type) ?>-1st" class="ns-color-picker" value="<?php echo esc_attr(isset($colors[0]) ? $colors[0] : '') ?>" />
                    </div>
                    
                    <div class="second-color-wrap ns-color-item">
                        <span class="ns-label"><?php echo esc_html__('Color 2nd', 'nasa-core'); ?></span>
                        <input type="text" id="term-<?php echo esc_attr($type) ?>-2nd" class="ns-color-picker" value="<?php echo esc_attr(isset($colors[1]) ? $colors[1] : '') ?>" />
                    </div>
